...
source = "data_all_1"
upsample_input = 2 # times to
downsample_input = 2 # meaning half it
...
train_data_majority_downsampled = resample(train_data_majority,
                           replace=False,
                           n_samples=int(len(train_data_majority)/2),
                           random_state=0)
train_data_downsampled = pd.concat([train_data_majority_downsampled, train_data_minority])
X_train = train_data_downsampled.copy().iloc[:, :-1]
Y_train = train_data_downsampled["y"]
print("downsampled data set class counts: ", Y_train.value_counts())
